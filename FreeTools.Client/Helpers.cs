...
using FreeTools.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
using FreeTools.Client.Pages.Settings.Users;
using FreeTools.Client.Shared;
using Humanizer;
...
using static FreeTools.DataObjects;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<FreeTools.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
