using RONet.Client.Pages;
using RONet.Components;
using RONet.Server.Hubs;
...
namespace RONet
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(RONet.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(RONet.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<ronetHub>("/ronetHub", signalRConnctionOptions => {
