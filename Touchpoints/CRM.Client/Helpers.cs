...
using Touchpoints.Client.Pages.Settings.Email;
// {{ModuleItemEnd:EmailTemplates}}
// {{ModuleItemStart:Locations}}
using Touchpoints.Client.Pages.Settings.Locations;
// {{ModuleItemEnd:Locations}}
// {{ModuleItemStart:Services}}
using Touchpoints.Client.Pages.Settings.Services;
// {{ModuleItemEnd:Services}}
// {{ModuleItemStart:Tags}}
using Touchpoints.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
