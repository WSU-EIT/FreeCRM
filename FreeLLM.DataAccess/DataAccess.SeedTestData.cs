...
#if DEBUG
        if (_connectionString == "Data Source=localhost;Initial Catalog=FreeLLM;TrustServerCertificate=True;User ID=sa;Password=saPassword;MultipleActiveResultSets=True;") {
