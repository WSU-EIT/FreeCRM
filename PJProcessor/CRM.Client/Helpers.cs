...
using PJProcessor.Client.Pages.Settings.Email;
// {{ModuleItemEnd:EmailTemplates}}
// {{ModuleItemStart:Locations}}
using PJProcessor.Client.Pages.Settings.Locations;
// {{ModuleItemEnd:Locations}}
// {{ModuleItemStart:Services}}
using PJProcessor.Client.Pages.Settings.Services;
// {{ModuleItemEnd:Services}}
// {{ModuleItemStart:Tags}}
using PJProcessor.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
