...
using WebDevExample.Client.Pages.Settings.Users;
using WebDevExample.Client.Shared;
using Humanizer;
...
using static WebDevExample.DataObjects;
using static MudBlazor.Colors;

namespace WebDevExample.Client;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<WebDevExample.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
