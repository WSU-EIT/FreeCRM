...
namespace RONet.EFModels.EFModels;
...
public partial class EFDataModel : DbContext
{
    ...
    // => optionsBuilder.UseSqlite("Data Source=C:\\Working\\RONet.db");
    // => optionsBuilder.UseMySQL("Server=localhost;Database=RONet;User=admin;Password=admin");
    // => optionsBuilder.UseNpgsql("Host=localhost;Database=RONet;Username=postgres;Password=admin");
    // => optionsBuilder.UseSqlServer("Data Source=(local);Initial Catalog=RONet;Persist Security Info=True;User ID=sa;Password=saPassword;MultipleActiveResultSets=True;TrustServerCertificate=True;");
