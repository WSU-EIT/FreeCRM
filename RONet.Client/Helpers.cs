...
using RONet.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
using RONet.Client.Pages.Settings.Users;
using RONet.Client.Shared;
using Humanizer;
...
using static RONet.DataObjects;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<RONet.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
