...
using FlexCRM.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
using FlexCRM.Client.Pages.Settings.Users;
using FlexCRM.Client.Shared;
using Humanizer;
...
using static FlexCRM.DataObjects;
using static MudBlazor.Colors;

namespace FlexCRM.Client;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<FlexCRM.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
