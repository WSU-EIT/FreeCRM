using FreeAI.Client.Pages;
using FreeAI.Components;
using FreeAI.Server.Hubs;
...
namespace FreeAI
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeAI.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeAI.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freeaiHub>("/freeaiHub", signalRConnctionOptions => {
