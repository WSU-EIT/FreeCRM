...
namespace AcademicCalendarPetitions.EFModels.EFModels;
...
public partial class EFDataModel : DbContext
{
    ...
    // => optionsBuilder.UseSqlite("Data Source=C:\\Working\\AcademicCalendarPetitions.db");
    // => optionsBuilder.UseMySQL("Server=localhost;Database=AcademicCalendarPetitions;User=admin;Password=admin");
    // => optionsBuilder.UseNpgsql("Host=localhost;Database=AcademicCalendarPetitions;Username=postgres;Password=admin");
    // => optionsBuilder.UseSqlServer("Data Source=(local);Initial Catalog=AcademicCalendarPetitions;Persist Security Info=True;User ID=sa;Password=saPassword;MultipleActiveResultSets=True;TrustServerCertificate=True;");
