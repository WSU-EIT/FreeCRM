...
using FreeTwilio.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
using FreeTwilio.Client.Pages.Settings.Users;
using FreeTwilio.Client.Shared;
using Humanizer;
...
using static FreeTwilio.DataObjects;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<FreeTwilio.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
