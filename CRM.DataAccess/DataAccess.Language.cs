...
public partial class DataAccess
{
    ...
    public DataObjects.Language GetDefaultLanguage()
    {
        ...
        Dictionary<string, string> language = new Dictionary<string, string> {
            ...
            // Workflows
            { "AddFirstWorkflow", "Add the First Workflow" },
            { "AddWorkflow", "Add Workflow" },
            { "CSharpAdditionalAssemblies", "Additional Assemblies" },
            { "CSharpAdditionalAssembliesNotes", "Optional: Enter any assemblies that need to be included using the following convention to get the library location from a property:<br><br>typeof(System.Dynamic.ExpandoObject).Assembly.Location" },
            { "CSharpCode", "Code" },
            ...
            { "ExportChart", "Export" },
            { "ExportChartPNG", "Image (PNG)" },
            { "ExportChartSVG", "Vector Image (SVG)" },
            { "FormHasNoWorkflows", "This Form Has No Workflows" },
            { "FormHasWorkflows", "Form Has Workflows" },
            { "Process", "Process" },
            { "ProcessWorkflowItem", "Process Workflow Item" },
            { "RemoveWorkflowOrphans", "Remove all Orphaned and Deleted Nodes" },
            { "ReProcessWorkflowItem", "Re-Process Workflow Item" },
            { "ReProcessWorkflowItemScheduledWarning", "Proceeding will reprocess this workflow item, proceed with caution. All previous data for this workflow item and any child items will be removed and the process will be scheduled to run again." },
            { "ReProcessWorkflowItemNeverScheduledWarning", "WARNING: This workflow item was never scheduled to run, proceed with caution. All previous data for this workflow item and any child items will be removed and the process will be scheduled to run again." },
            { "ViewWorkflow", "View" },
            { "Workflow", "Workflow" },
            { "WorkflowApprovalOption", "Approval Options" },
            { "WorkflowApprovalOptionApprove", "Simple Approve/Deny Interface" },
            { "WorkflowApprovalOptionSign", "Approve/Deny Interface Plus Signature" },
            { "WorkflowApprovalRetries", "Retries" },
            { "WorkflowApprovalRetriesNotes", "Enter 1 for a single attempt. Otherwise, enter the number of times this email will be sent to the approver before it is considered denied." },
            { "WorkflowApprovalRetryInterval", "Retry Interval" },
            { "WorkflowApprovalRetryIntervalNotes", "Enter the number of minutes between retries. After the last retry attempt this will also be the waiting period before this is considered denied.<br>(eg: 1 hour = 60 minutes, 1 day = 1440 minutes, 7 days = 10080 minutes)" },
            { "WorkflowCompleted", "Completed" },
            { "WorkflowCompleteTip", "Add a Workflow that runs whether this Workflow succeeds or fails." },
            { "WorkflowCopy", "Copy Workflow" },
            { "WorkflowCustomFieldValues", "Custom Field Values" },
            { "WorkflowObjectData", "Workflow Object Data" },
            { "WorkflowFailed", "Failed" },
            { "WorkflowFailureTip", "Add a Workflow that runs if this Workflow fails." },
            { "WorkflowId", "Workflow Id" },
            { "WorkflowMove", "Move Workflow" },
            { "WorkflowMoveHere", "Move Here" },
            { "WorkflowName", "Workflow Name" },
            { "WorkflowNotCompleted", "Not Completed" },
            { "WorkflowNoWorkflows", "No Workflows<br>Defined" },
            { "WorkflowObjects", "Objects" },
            { "WorkflowOnComplete", "On Complete" },
            { "WorkflowOnFailure", "On Failure" },
            { "WorkflowOnSuccess", "On Success" },
            { "WorkflowOrphanedAndDeleted", "Orphaned and Deleted Nodes" },
            { "WorkflowOrphanedAndDeletedFull", "Workflow Orphaned and Deleted Nodes" },
            { "WorkflowPaste", "Paste Copied Workflow" },
            { "WorkflowProcessingComplete", "Workflow<br>Processing<br>Complete" },
            { "WorkflowProcessStatus", "Workflow Process Status" },
            { "WorkflowQuerystringValues", "Querystring Values" },
            { "WorkflowReprocessHere", "Reprocess Workflows Starting Here" },
            { "WorkflowResult", "Result" },
            { "WorkflowRunning", "Running" },
            { "Workflows", "Workflows" },
            { "WorkflowScheduled", "Scheduled" },
            { "WorkflowsInfo", "Workflows are items that are processed by a separate backend processing engine after the form has been submitted. This could be a minute or two after the submission, depending on how the processor is configured." },
            { "WorkflowStart", "Start" },
            ...
            { "WorkflowType", "Type" },
            { "WorkflowTypeEmail", "Send Email" },
            { "WorkflowTypeFilter", "Filter Records" },
            { "WorkflowTypeCustomVariable", "Custom Variable" },
            { "WorkflowTypeClearCustomVariable", "Clear Custom Variable" },
            { "WorkflowTypeDelete", "Delete Record" },
            { "WorkflowTypeExternalApp", "Execute External Application" },
            { "WorkflowTypeCSharp", "Execute C# Code" },
            { "WorkflowTypeEmailApproval", "Send an Email for Approval" },
            { "WorkflowUnscheduled", "Unscheduled" },
            { "WorkflowZoomLevel", "Workflow Zoom Level" },
            ...
            { "AppendRenderedItemToBody", "Append Rendered Item to Body" },
            { "AppendRenderedItemToBodyAttachmentFormat", "Attachment Format" },
            { "AppendRenderedItemToBodyAttachmentFormatHtml", "HTML" },
            { "AppendRenderedItemToBodyAttachmentFormatPdf", "PDF" },
            { "AppendRenderedItemToBodyAttachmentFormatPdfDocumentSize", "PDF Document Size" },
            { "AppendRenderedItemToBodyAttachmentFormatPdfDocumentSizeLedger", "Ledger" },
            { "AppendRenderedItemToBodyAttachmentFormatPdfDocumentSizeLegal", "Legal" },
            { "AppendRenderedItemToBodyAttachmentFormatPdfDocumentSizeLetter", "Letter" },
            { "AppendRenderedItemToBodyAttachmentFormatPdfDocumentSizeTabloid", "Tabloid" },
            { "AppendRenderedItemToBodyInfo", "When selected the rendered item will be included at the end of the body. NOTE: Not all email clients will render the HTML of the item correctly." },
            ...
            { "EmailBody", "Body" },
            { "EmailCc", "Cc" },
            { "EmailNoRecipients", "No Email Recipients" },
            { "EmailNoRecipientsInfo", "You must add at least one email recipient. You can use email addresses or fields. Reference field names inside double curly brackets using the FieldId for GUI forms or the field name for HTML forms (eg: {{fieldid}})" },
            ...
            { "ExternalAppInfo", "either a path relative to the context where the form will run or a fully-qualified path to the application" },
            { "ExternalAppParameters", "Parameters" },
            { "ExternalAppParametersInfo", "Optional parameters to pass to the application. Use the standard curly bracket option for available form fields and options such as {{recordid}}." },
            ...
            { "IncludeItemAsAttachment", "Include the Item as an Attachment" },
            ...
            { "SearchFieldsInfo", "Enter that names of fields or the FieldId GUID values of fields to search." },
            { "SearchLanguageTag", "Search for a Language Tag to Edit" },
            { "SearchUsers", "Search Users" },
            { "SearchWords", "Search Words" },
            { "SearchWordsInfo", "Enter words to search for, or use * to match any word" },
            { "Select", "Select" },
            ...
            { "ValidatingWait", "Validating, Please Wait..." },
