...
using AcademicCalendarPetitions.Client.Pages.Settings.Users;
using AcademicCalendarPetitions.Client.Shared;
using Humanizer;
...
using static AcademicCalendarPetitions.DataObjects;
using static MudBlazor.Colors;

namespace AcademicCalendarPetitions.Client;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<AcademicCalendarPetitions.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
