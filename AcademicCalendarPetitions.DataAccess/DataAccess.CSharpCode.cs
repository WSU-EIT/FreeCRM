...
public partial class DataAccess
{
        ...
        string invokerFunction)
    {
        ...
        try {
            ...
            try { references.Add(Microsoft.CodeAnalysis.MetadataReference.CreateFromFile(typeof(AcademicCalendarPetitions.EFModels.EFModels.User).Assembly.Location)); } catch { }
