using FreeTools.Client.Pages;
using FreeTools.Components;
using FreeTools.Server.Hubs;
...
namespace FreeTools
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeTools.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeTools.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freetoolsHub>("/freetoolsHub", signalRConnctionOptions => {
