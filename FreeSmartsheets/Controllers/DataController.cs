...
namespace FreeSmartsheets.Server.Controllers;
...
public partial class DataController : ControllerBase
{
    ...
    private readonly IHubContext<freesmartsheetsHub, IsrHub>? _signalR;
    ...
    public DataController(IDataAccess daInjection,
        ...
        IHubContext<freesmartsheetsHub, IsrHub> hubContext,
