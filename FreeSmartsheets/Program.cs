using FreeSmartsheets.Client.Pages;
using FreeSmartsheets.Components;
using FreeSmartsheets.Server.Hubs;
...
namespace FreeSmartsheets
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeSmartsheets.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeSmartsheets.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freesmartsheetsHub>("/freesmartsheetsHub", signalRConnctionOptions => {
