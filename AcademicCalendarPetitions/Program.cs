...
namespace AcademicCalendarPetitions
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(AcademicCalendarPetitions.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(AcademicCalendarPetitions.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<academiccalendarpetitionsHub>("/academiccalendarpetitionsHub", signalRConnctionOptions => {
