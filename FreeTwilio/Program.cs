using FreeTwilio.Client.Pages;
using FreeTwilio.Components;
using FreeTwilio.Server.Hubs;
...
namespace FreeTwilio
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeTwilio.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeTwilio.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freetwilioHub>("/freetwilioHub", signalRConnctionOptions => {
