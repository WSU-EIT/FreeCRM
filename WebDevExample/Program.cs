using WebDevExample.Client.Pages;
using WebDevExample.Components;
using WebDevExample.Server.Hubs;
...
namespace WebDevExample
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(WebDevExample.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(WebDevExample.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<webdevexampleHub>("/webdevexampleHub", signalRConnctionOptions => {
