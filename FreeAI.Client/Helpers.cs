...
using FreeAI.Client.Pages.Settings.Email;
// {{ModuleItemEnd:EmailTemplates}}
// {{ModuleItemStart:Locations}}
using FreeAI.Client.Pages.Settings.Locations;
// {{ModuleItemEnd:Locations}}
// {{ModuleItemStart:Services}}
using FreeAI.Client.Pages.Settings.Services;
// {{ModuleItemEnd:Services}}
// {{ModuleItemStart:Tags}}
using FreeAI.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
using FreeAI.Client.Pages.Settings.Users;
using FreeAI.Client.Shared;
using Humanizer;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<FreeAI.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
