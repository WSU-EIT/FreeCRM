using FlexCRM.Client.Pages;
using FlexCRM.Components;
using FlexCRM.Server.Hubs;
...
namespace FlexCRM
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FlexCRM.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FlexCRM.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<flexcrmHub>("/flexcrmHub", signalRConnctionOptions => {
