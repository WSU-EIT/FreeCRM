...
namespace FlexCRM.EFModels.EFModels;
...
public partial class EFDataModel : DbContext
{
    ...
    // => optionsBuilder.UseSqlite("Data Source=C:\\Working\\FlexCRM.db");
    // => optionsBuilder.UseMySQL("Server=localhost;Database=FlexCRM;User=admin;Password=admin");
    // => optionsBuilder.UseNpgsql("Host=localhost;Database=FlexCRM;Username=postgres;Password=admin");
    // => optionsBuilder.UseSqlServer("Data Source=(local);Initial Catalog=FlexCRM;Persist Security Info=True;User ID=sa;Password=saPassword;MultipleActiveResultSets=True;TrustServerCertificate=True;");
