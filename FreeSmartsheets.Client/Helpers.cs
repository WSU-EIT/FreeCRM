...
using FreeSmartsheets.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
using FreeSmartsheets.Client.Pages.Settings.Users;
using FreeSmartsheets.Client.Shared;
using Humanizer;
...
using static FreeSmartsheets.DataObjects;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<FreeSmartsheets.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
